...
export function Header({ tab, setTab, filteredCount, totalCount, isDark, toggleDark }) {
  const tabs = ["Overview", "Trends", "Listings", "Brand & Model", "Compare", "Insights"];
  const isFiltered = filteredCount !== totalCount;

  return (
    <>
      <div
        className="flex items-center justify-between px-4 md:px-7 py-3 md:py-4 border-b"
      ...
      >
        <div className="flex items-center gap-4">
          ...
          {/* Desktop-only: divider, label, count badge */}
        ...
        {tabs.map((t) => {
          ...
          return (
            <button
              ...
              style={{ color: active ? LIME_DEEP : GRAY_500 }}
            >
              <div
                style={{
                  width: 4,
